...
public class MainActivity extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnNearBy= (Button) findViewById(R.id.btnNearByPlaces);
	...
	private void displayLocation() {
		...
		if (mLastLocation != null) {
			...
			((TextView)findViewById(R.id.txtCurrentLocation)).setText("Current Address:"+addr);
	...
	public void onClick(View v) {
		...
		case R.id.btnNearByPlaces:
			startActivity(new Intent(MainActivity.this,
					ActivityDashboard.class).putExtra("SEARCH_STRING","food"));
	...
	private void updateUI(boolean isSignedIn) {
		if (isSignedIn) {
			...
			findViewById(R.id.textWelcome).setVisibility(View.GONE);
			llProfileLayout.setVisibility(View.VISIBLE);
		} else {
			btnSignIn.setVisibility(View.VISIBLE);
			findViewById(R.id.textWelcome).setVisibility(View.VISIBLE);
